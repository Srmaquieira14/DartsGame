...
public class EscenaJugar extends Escena {
    ...
    public EscenaJugar(Context context, int numEscena, int screenWidth, int screenHeight) {
    ...
    public void dibujar(Canvas c){
        ...
        c.drawText("ESCENA JUGAR: " + numEscena, screenWidth /10*3, screenHeight /20*1, pText);
